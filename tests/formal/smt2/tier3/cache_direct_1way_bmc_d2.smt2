; BMC d=2 for CacheDirectOneWay -- expects UNSAT
...
; Property (negated): write at state_1, but data array at state_2 has wrong value
(assert (|Cache#req_en|  |state_1|))
(assert (|Cache#req_we|  |state_1|))
(assert (not (= (select (|Cache#data| |state_2|)
                        ((_ extract 3 0) (|Cache#req_addr| |state_1|)))
               (|Cache#req_data| |state_1|))))
