; BMC d=4 for CacheDirectOneWay -- expects UNSAT
...
; Property (negated): write at state_3, but data array at state_4 has wrong value
(assert (|Cache#req_en|  |state_3|))
(assert (|Cache#req_we|  |state_3|))
(assert (not (= (select (|Cache#data| |state_4|)
                        ((_ extract 3 0) (|Cache#req_addr| |state_3|)))
               (|Cache#req_data| |state_3|))))
