; BMC d=4 for RegfileSimple -- expects UNSAT
...
; wr_en at state_3, rd_addr_3 == wr_addr_3, but rd_data_4 != wr_data_3
(assert (|RegfileSimple#wr_en|   |state_3|))
(assert (= (|RegfileSimple#rd_addr| |state_3|) (|RegfileSimple#wr_addr| |state_3|)))
(assert (not (= (|RegfileSimple#rd_data| |state_4|)
               (|RegfileSimple#wr_data| |state_3|))))
