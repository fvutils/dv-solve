; BMC d=8 for RegfileAddrAlias -- expects UNSAT
...
(declare-const |state_5| |RegfileAlias_s|)
(declare-const |state_6| |RegfileAlias_s|)
(declare-const |state_7| |RegfileAlias_s|)
(declare-const |state_8| |RegfileAlias_s|)
...
(assert (|RegfileAlias_t| |state_4| |state_5|))
(assert (|RegfileAlias_t| |state_5| |state_6|))
(assert (|RegfileAlias_t| |state_6| |state_7|))
(assert (|RegfileAlias_t| |state_7| |state_8|))

; Negate property at last transition:
; wr_en, wr_addr != rd_addr, but rd_data != old mem[rd_addr]
(assert (|RegfileAlias#wr_en|   |state_7|))
(assert (not (= (|RegfileAlias#rd_addr| |state_7|)
               (|RegfileAlias#wr_addr| |state_7|))))
; rd_data in next state should equal old mem[rd_addr]; negate:
(assert (not (= (|RegfileAlias#rd_data| |state_8|)
               (select (|RegfileAlias#mem| |state_7|)
                       (|RegfileAlias#rd_addr| |state_7|)))))
